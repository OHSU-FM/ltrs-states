...
$(document).on('page:load', function(){
    ...
    $('select#approval_state_status,select#leave_request_status,select#travel_request_status').each(function(){
...
$(document).ready(function(){
    ...
    var save_selectors = 'select#approval_state_status,select#leave_request_status,select#travel_request_status';
