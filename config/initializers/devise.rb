...
Devise.setup do |config|
  ...
  config.mailer_sender = "noreply@yourorg.com"
  ...
  # if you set :record_keys to [:subdomain], :subdomain will be used on authentication.
  ...
  # Error message told me to do it:
  # ruby-1.9.3-p545/gems/devise-3.2.3/lib/devise/rails/routes.rb:487:in
